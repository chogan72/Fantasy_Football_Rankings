...
files = [['Fantasy-Pros-Database','https://www.fantasypros.com/nfl/rankings/consensus-cheatsheets.php'],
         ['Fantasy-Pros-Rookies-Database','https://www.fantasypros.com/nfl/rankings/rookies.php']]

for file in files:
    #Player Format
    players = ['Name', 'Position', 'Team', 'Bye']
    database(file[0], players)
